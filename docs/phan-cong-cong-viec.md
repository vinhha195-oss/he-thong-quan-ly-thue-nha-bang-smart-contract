...
| Test | Viết 18 test case (nghiệp vụ + token + IPFS CID + bảo mật: chặn `safeTransferFrom`, chặn reentrancy qua contract độc hại) | `test/RentalManager.test.ts`, `contracts/mocks/MaliciousReceiver.sol` |
