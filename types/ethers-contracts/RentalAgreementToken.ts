...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface RentalAgreementTokenInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "MINTER_ROLE" | "approve" | "balanceOf" | "getApproved" | "getRoleAdmin" | "grantRole" | "hasRole" | "isApprovedForAll" | "mintAgreement" | "name" | "ownerOf" | "renounceRole" | "revokeRole" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'mintAgreement', values: [AddressLike, BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'mintAgreement', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  export interface RentalAgreementToken extends BaseContract {
    
    connect(runner?: ContractRunner | null): RentalAgreementToken;
    waitForDeployment(): Promise<this>;

    interface: RentalAgreementTokenInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    mintAgreement: TypedContractMethod<
      [tenant: AddressLike, propertyId: BigNumberish, ],
      [void],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'isApprovedForAll'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'mintAgreement'): TypedContractMethod<
      [tenant: AddressLike, propertyId: BigNumberish, ],
      [void],
      'nonpayable'
    >;
